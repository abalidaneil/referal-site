...
// Check if fast starter (first referral within 24 hours of account creation)
...
if ($has_first_referral) {
    ...
    $is_fast_starter = ($first_ref_created - $user_created) <= 86400; // 24 hours in seconds
}

// Check if OG (among first 100 users)
...
$badges = [
    ...
    // Quantity-Based (5, 10, 25, 50, 100, 250)
    [
        'id' => 'social_butterfly',
...
<head>
    ...
    <title>Badges & Rewards - Referral Hub</title>
...
<body>
    ...
    <div class="badges-container">
        <div class="badges-header">
            ...
            <p>Unlock badges by referring friends!</p>
        </div>
